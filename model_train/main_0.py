...
from Model.models import resnet18 as resnet18_cut
...
parser.add_argument('--model',type=str,default='resnet18_cut',choices=['resnet18','wrn_28','vgg16','resnet18_cut','Lenet','Alexnet'],help = 'choosing the model for victim model')
...
if __name__ == '__main__':
    ...
    elif args.model == 'resnet18_cut':
        Victim_model = resnet18_cut(num_classes=args.num_classes,penultimate_2d=False)
    elif args.model == 'Lenet':
        Victim_model = lenet(num_classes=args.num_classes)
    elif args.model == 'Alexnet':
        Victim_model = md.AlexNet(num_classes=args.num_classes)
