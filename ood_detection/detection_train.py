...
parser.add_argument('--attack',type=str,default='DFME',choices=['KNOCKOFF','DFME','IDA'],help='choosing the attack forms')
parser.add_argument('--dataset',type=str,default='MNIST',choices=['MNIST', 'CIFAR10', 'CIFAR100', 'FMNIST', 'FOOD101'], help='choosing the dataset for target model')
parser.add_argument('--model',type=str,default='resnet18',choices=['resnet18','wrn28'],help = 'choosing the model for target model')
...
'''setting dataset'''
train_path = r'../model_train/Dataset/' +'/'+ args.dataset + '/'+args.dataset+'_'+args.type+'/train'
test_path = r'../model_train/Dataset/' +'/'+ args.dataset + '/'+args.dataset+'_'+args.type+'/test'
...
optimizer = torch.optim.SGD(
    target_model.parameters(), state['learning_rate'], momentum=state['momentum'],
...
def train():
    target_model.train()  # enter train mode
    loss_avg = 0.0
...
if __name__ == '__main__':
    ...
    print('The accuracy of target model after OE is {}'.format(accuracy,'.2f'))
