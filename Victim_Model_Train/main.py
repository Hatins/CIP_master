...
parser.add_argument('--attack', type=str, default='datafree', choices=['knockoff', 'datafree', 'IDA'], help='attack method')
parser.add_argument('--dataset',type=str, default='MNIST', choices=['MNIST','GTSRB','CIFAR10','CIFAR100','Fashion_MNIST','FOOD101'], help='dataset selection')
