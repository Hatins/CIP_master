...
if __name__ == '__main__':
    ...
    parser.add_argument('--attack', type=str, default='Knockoff', choices=['Prada', 'Knockoff', 'Datafree'],help='choosing the attack forms')
    parser.add_argument('--dataset', type=str, default='Cifar10', choices=['Mnist', 'Gtsrb', 'Cifar10', 'Fashion_mnist', 'Cifar100','FOOD101'], help='choosing the dataset for victim model')
    ...
    if args.method == 'CIP':
        output_list = poison_fun_tensor(args, Victim_model, image_tensor, None, args.attack, args.ratio, args.dataset,
                                        args.trigger_path, SPPD, poison=args.poison)  # TODO:
    elif args.method == 'DP':
        output_list = DP_poison(Victim_model, image_tensor, None, poison=args.poison)
    elif args.method == 'DAWN':
        output_list = DAWN_poison(Victim_model, image_tensor, None, args.attack, args.ratio, args.dataset,
                                  args.trigger_path, poison=args.poison)  # TODO:
